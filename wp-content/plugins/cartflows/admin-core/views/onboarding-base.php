...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php // phpcs:disable WordPressVIPMinimum.UserExperience.AdminBarRemoval.HidingDetected ?>
		<style>
			#wpadminbar { display: none !important; }
			html { margin-top: 0 !important; }
		</style>
		<?php // phpcs:enable WordPressVIPMinimum.UserExperience.AdminBarRemoval.HidingDetected ?>
		...
		<?php wp_print_scripts( array( 'wcf-onboarding-app', 'wcf-onboarding-helper' ) ); ?>
		<?php
	...
	<body class="cartflows-setup wp-core-ui" style="background-color: #f0f0f1; ">
		<div id="wcf-onboarding-page" class="wcf-onboarding-page-wrapper" ></div>
	</body>
	<?php wp_footer(); ?>
</html>
<?php exit; ?>
